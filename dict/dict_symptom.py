...
now = datetime.now()
table_df = {}
table_columns = ['symptom_code_upload', 'symptom_name', 'remark']
...
table_df['symptom_id'] = table_df.index
table_df.set_index(['symptom_id'], inplace=True)
...
#     engine.execute("delete from dict_symptom")
#     table_df.to_sql('dict_symptom', engine, schema='oh', index=True, if_exists='append')
